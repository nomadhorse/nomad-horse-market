...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      @media(max-width:620px){.nh-money-row{grid-template-columns:1fr}.nh-finance-summary{grid-template-columns:1fr}.nh-form-grid{grid-template-columns:1fr}.nh-form-grid .full{grid-column:auto}.nh-schedule-row{grid-template-columns:1fr auto}.nh-schedule-money{grid-column:1/-1;text-align:left}}
    `;
